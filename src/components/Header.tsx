...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header id="app-header" className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-xs">
      {/* 1. Top Row: Brand Logo & Title */}
      <div className="px-3 sm:px-5 py-1.5 border-b border-slate-100">
      ...
      {/* 2. Independent Toolbar: Placed directly underneath the logo and aligned to the left */}
      <div id="header-actions-toolbar-row" className="px-3 sm:px-5 py-1 border-b border-slate-100 bg-white">
        <div className="max-w-7xl mx-auto flex items-center justify-start gap-1 flex-wrap text-xs">
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-0.5">
          ...
          <div className="flex items-center gap-1 overflow-x-auto text-[11px] font-semibold custom-scrollbar">
            ...
            <button
              ...
              className={`px-2 py-0.5 rounded-md flex items-center gap-1 transition-all border border-[#e2cbca] ${
                activeTab === 'cargo'
                  ? 'bg-slate-900 text-white shadow-xs font-bold'
